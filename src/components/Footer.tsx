    ...
    return (
        <div>
            <div className="w-full h-[55vh] bg-[url('/footer-image.png')] bg-cover bg-center flex flex-col items-center justify-center">
                <h1 className='font-bold text-center mt-10 text-white'>Ready to cook up your next growth experiment?</h1>
                <h1 className='font-bold text-center text-white'>Let’s get in the lab — strategy goggles on, results incoming.</h1>
                <Link href={'/contact'} className='mt-4 px-6 py-2 bg-zinc-700 rounded-md text-white'>Let's Talk</Link>
            </div>
            ...
            <div className="bg-[#4DD1F4] w-full py-10 px-8 flex justify-between">
                ...
                <div className="flex flex-col space-y-4">
                    ...
                    <p className="text-xs mt-2">The Strategy Lab is a trademark.<br />All rights reserved</p>
                </div>
                ...
                <div className='w-[15%]'>
                    ...
                    <p className="mb-2">Have a question, a project, or just wanna nerd out over strategy?</p>
                ...
                <div className="max-w-xs">
                    <h3 className="font-bold mb-2">Stay in the Lab Loop</h3>
                    <p className="mb-3">Want in on our experiments, strategies, and marketing breakthroughs? Drop your email below — we’ll only send stuff worth testing!</p>
